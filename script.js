...
const saludar1 = saludar('Cris');
const saludar2 = saludar('Victor');
const saludar3 = saludar('Rocio');
...
const area1 = calcularAreaRectangulo(2, 4);
const area2 = calcularAreaRectangulo(2, 5);
